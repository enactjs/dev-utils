...
module.exports = {
	/*
		Prepare sourcecode by rewiring external requests for enact_framework and modifing the chunk
		loader to be isomorphic-compatible.
	...
	*/
	prepare: function(code, opts) {
		code = code.replace('return __webpack_require__(0);',
	...
	/*
		Generate HTML string from prepared sourcecode via a sandboxed VM.
